 ...
 * @return void
 */
void Blackboard::insert(const std::string &name, BlackboardType* item)
{
 ...
 * @return bool
 */
bool Blackboard::getValue(const std::string &name, int &out)
{
...
* @return bool
*/
bool Blackboard::getValue(const std::string &name, float &out)
{
	auto result = map.find(name);
	if (result != map.end())
	{
...
* @return bool
*/
bool Blackboard::getValue(const std::string &name, double &out)
{
	auto result = map.find(name);
	if (result != map.end())
	{
...
* @return bool
*/
bool Blackboard::getValue(const std::string &name, char &out)
{
	auto result = map.find(name);
	if (result != map.end())
	{
...
* @return bool
*/
bool Blackboard::getValue(const std::string &name, std::string &out)
{
	auto result = map.find(name);
	if (result != map.end())
	{
 ...
 * @return bool
 */
bool Blackboard::setValue(const std::string &name, const int &value)
{
	auto result = map.find(name);
	if(result != map.end())
	{
...
* @return bool
*/
bool Blackboard::setValue(const std::string &name, const float& value)
{
	auto result = map.find(name);
	if (result != map.end())
	{
...
* @return bool
*/
bool Blackboard::setValue(const std::string &name, const double& value)
{
	auto result = map.find(name);
	if (result != map.end())
	{
...
* @return bool
*/
bool Blackboard::setValue(const std::string &name, const char& value)
{
	auto result = map.find(name);
	if (result != map.end())
	{
...
* @return bool
*/
bool Blackboard::setValue(const std::string &name, const std::string& value)
{
	auto result = map.find(name);
	if (result != map.end())
	{
 ...
 */
BlackboardType* Blackboard::getPointer(const std::string &name)
{
	auto result = map.find(name);
	if (result != map.end())
	{
